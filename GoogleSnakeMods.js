...
function injectInitialHtmlAnimatedSnake() {
  ...
  <div style="width:300px;padding:10px;background-color:#373629;z-index:9012;border-color:blue;border-style:solid;border-width:2px;;box-shadow: 0 3px 10px rgba(0,0,0,0.5);position:fixed;right:5px;top:5px">
      <div class="font-effect-fire" style="text-align:center;padding:2px;background-color:transparent;font-family:sofia;font-size:25px">Animated Snake By Zaddy Braxton</div>
      <div style="background-color:#555543;margin-top:5px;padding:0px;padding-bottom:10px;font-family:calibri;color:#fffeec;">
        <div style="margin:auto;padding:3px">
          <p style="margin-top:0"> <span style="color:purple;">You will need to choose the rainbow snake for the mod to work. <span style="color:blue;">Warning: This is cool.</span></p>
          Snake Pattern
          <br>
          <select id="snake-pattern-chooser">
            <option value="none">none</option>
            <option value="defaultPattern">Bugged</option>
            <option value="seizure">Seizure</option>
            <option value="temporalRainbow">Slow Rainbow</option>
            <option value="rollingRainbow">Normal Rainbow</option>
            <option value="rollingRainbowRev" selected="">Rolling Rainbow</option>
            <option value="strobeRainbow">Strobe Rainbow</option>
            <option value="variation">Variation</option>
            <option value="variationV2">Variation 2</option>
          </select>
        ...
        <div style="margin:auto;padding:3px">
          ...
          <select id="background-pattern-chooser">
            ...
            <option value="randomHexBg">TV Staic</option>
            <option value="randomHexSameBg">Sezure</option>
            <option value="temporalBg">LSD</option>
            <option value="rollingRainbowBg">Rainbow Road</option>
            <option value="rollingRainbowBgOld">Cool</option>
          </select>
        </div>
        <div style="margin:auto;padding:3px">
